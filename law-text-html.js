...
try {
    ...
    if (imageInfoDict.statIconOne.content && imageInfoDict.statColorOne.content && imageInfoDict.statHeadingOne.content) {
        ...
        // set card defaults
        let openCardWrapperOne = '<div class="cardinfographicItem card border-lg-0 rounded-0 color' + imageInfoDict.statColorOne.content + '">';
    ...
    if (imageInfoDict.statIconTwo.content && imageInfoDict.statColorTwo.content && imageInfoDict.statHeadingTwo.content) {
        ...
        // set card defaults
        let openCardWrapperTwo = '<div class="cardinfographicItem card border-lg-0 rounded-0 color' + imageInfoDict.statColorTwo.content + '">';
    ...
    if (imageInfoDict.statIconThree.content && imageInfoDict.statColorThree.content && imageInfoDict.statHeadingThree.content) {
        ...
        // set card defaults
        let openCardWrapperThree = '<div class="cardinfographicItem card border-lg-0 rounded-0 color' + imageInfoDict.statColorThree.content + '">';
    ...
    if (imageInfoDict.statIconFour.content && imageInfoDict.statColorFour.content && imageInfoDict.statHeadingFour.content) {
        ...
        // set card defaults
        let openCardWrapperFour = '<div class="cardinfographicItem card border-lg-0 rounded-0 color' + imageInfoDict.statColorFour.content + '">';
    ...
    if (imageInfoDict.statIconFive.content && imageInfoDict.statColorFive.content && imageInfoDict.statHeadingFive.content) {
        ...
        // set card defaults
        let openCardWrapperFive = '<div class="cardinfographicItem card border-lg-0 rounded-0 color' + imageInfoDict.statColorFive.content + '">';
